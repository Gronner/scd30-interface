...
## [2.0.2](https://github.com/Gronner/scd30-interface/compare/v2.0.1...v2.0.2) - 2026-09-13

### Fixed

- *(ci)* enable persist-credentials to ensure release follow ups run

## [2.0.1](https://github.com/Gronner/scd30-interface/compare/v2.0.0...v2.0.1) - 2026-09-12

### Other

- *(deps)* update dependencies
- *(ci)* update ci and release workflows
